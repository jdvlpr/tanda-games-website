...
- **`game_specification.md`**: The authoritative rulebook for the physical board game.
...
- **Optional Actions:** Can be performed before a required action and do *not* end the turn (e.g., `sell` a card from the stash for $2, `graduate`).
