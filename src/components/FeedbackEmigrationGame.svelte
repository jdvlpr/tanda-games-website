...
<button
  ...
  >{title} {@html expand ? iconUp : iconDown}</button
>
...
{#if expand}
  <div class="flex flex-col items-center">
    ...
    <form
      ...
      method="POST"
      class="inline-flex flex-wrap items-start justify-start gap-4 mb-8 text-left p-4 bg-neutral-100 dark:bg-neutral-800 rounded-2xl"
    >
      <p class="w-full mb-4 italic">
        Fill out this form after you've play the game, or if you have a question
        or comment. All responses are optional.
      </p>
      ...
      <div class="flex flex-col gap-2 flex-1">
        ...
        {#if playerNamesInput && !playerNamesInput.includes(",")}
          <p class="text-sm text-red-400">
            Separate names of players by comma ( , )
          </p>
        {/if}
      </div>
      ...
      {#if players}
        {#each players as player, index (player)}
          <div
            class="w-full flex flex-col gap-2 justify-start items-start mb-4"
          >
      ...
      <div class="flex flex-col gap-2 flex-1">
        ...
        <p class="text-sm italic">
          ...
          your strategy, and did it work as you expected? What were your
          favorite and least favorite things about the game? Did you have enough
          or too many tokens?
        </p>
        <textarea
          id="comments"
      ...
      {#if email}
        <div class="flex justify-center items-center gap-2 w-full">
          ...
          />
          <label for="wants-autoresponse"
            >Send a copy of this form to {email}</label
          >
        </div>
        {#if autoResponse}
          <input
