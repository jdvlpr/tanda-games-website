<script>
  ...
  /** @type {Props} */
  let { title = "Feedback", version, discordLink, changelog } = $props();
...
<div class="my-2 flex flex-col gap-2">
  ...
  <a href={discordLink} rel="nofollow noopener" target="_blank" class="btn-sm">
  ...
  <form
    ...
    method="POST"
    class="inline-flex flex-wrap items-start justify-start gap-4 mb-8 text-left"
  >
    <p class="w-full my-2">
      Fill out the form below after you've play the game or if you have a
      question or comment. All responses are optional. Thank you for your
      feedback!
    </p>
    ...
    <div class="flex flex-col gap-1 flex-1">
      ...
      <p class="text-sm italic">
        ...
        your strategy, and did it work as you expected? What were your favorite
        and least favorite things about the game? Did you have enough or too
        many tokens?
      </p>
      <textarea
        id="comments"
