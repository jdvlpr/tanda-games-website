...
{#if anchorRect}
  ...
  <div
    ...
    class="rounded-md shadow-lg border border-neutral-200 dark:border-neutral-800 bg-yellow-100 dark:bg-yellow-900"
  >
    <!-- Arrow pointing toward the card -->
    {#if position.below}
      <div
        class="absolute -top-1.5 left-1/2 -translate-x-1/2 size-3 bg-yellow-100 dark:bg-yellow-900 rotate-45 border-l border-t border-neutral-200 dark:border-neutral-800 z-10"
      ></div>
    {:else}
      <div
        class="absolute -bottom-1.5 left-1/2 -translate-x-1/2 size-3 bg-yellow-100 dark:bg-yellow-900 rotate-45 border-r border-b border-neutral-200 dark:border-neutral-800 z-10"
      ></div>
    {/if}
    ...
    <div class="p-2 flex flex-wrap gap-1.5">
      {#each actions as action}
        {#if action.enabled}
          <button
            class="btn-sm whitespace-nowrap flex-1 bg-white dark:bg-black"
