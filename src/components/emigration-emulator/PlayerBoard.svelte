...
>
  ...
  >
    ...
    <div class="flex gap-1 items-center">
      ...
      <div
        class="size-7 rounded-full border border-dashed flex items-center justify-center {player.payRaises >=
    ...
    <span
      class="flex gap-1 items-center text-pink-700 dark:text-pink-300"
      title="Access Fee"
    >
      <svg
        class="Icon size-5"
    ...
    <span
      class="flex gap-1 items-center text-red-600 dark:text-red-400"
      title="Assurance"
    >
