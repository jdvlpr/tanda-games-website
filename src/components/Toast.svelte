...
>
    ...
    <button 
        ...
        class="ml-2 opacity-50 hover:opacity-100 transition-opacity cursor-pointer"  
        aria-label="Close"
    >
        <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" class="size-5" viewBox="0 0 20 20" fill="currentColor">
